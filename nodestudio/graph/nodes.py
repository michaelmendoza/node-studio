...
NodeInfo = {
    ...
    NodeType.SENSITIVITY_MAP: NodeProps(type=NodeType.SENSITIVITY_MAP,name='Sensitivity Map',description='Calculates sensitivity map',detail=NodeDetail.UNDERSAMPLE, input=['a'], output=['out'], fn=get_sensitivity_map),
