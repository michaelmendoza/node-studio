...
class NodeDetail(Enum):
    ...
    SENSE = '''SENSE is an common image domain based reconstruction algorithm. The input is undersampled k-space data where every few rows are skipped. SENSE uses the prior knowledge of the sensitivity profile as additional spatial encoding to ‘unfold’ the aliased image'''
