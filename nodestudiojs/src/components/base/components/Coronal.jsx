...
const Coronal = ({position, setPosition, picturesize, nodeID, colMap, intensity, setIntensity}) => {
  ...
  return (
    ...
    <div className='viewer-3d'>  
        <div className='viewer-continer' style={{ width : picturesize.x , height : picturesize.z }} ref={viewerRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
          <ImageRender slice={'xz'} index={position.y/picturesize.y} colormap={colMap} nodeID={nodeID} position={position} intensity={intensity} setIntensity={setIntensity}></ImageRender>
