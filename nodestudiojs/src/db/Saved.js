...
const json_string_rawdata = `{"nodes": [
    ...
    {"id": "922ec681-f999-4691-bef7-9cc34ebaf5f2", "props": {"type": "CDISPLAY", "name": "Display (Complex Numbers)", "description": "Displays complex data as an image", "input": ["In"], "output": [], "options": [{"name": "datatype", "select": ["mag", "phase", "real", "imag"]}]}, "inputs": ["4a1922cc-bff0-4aea-bee5-4853c6458bc6"], "outputs": [], "styles": {"x": 530, "y": 54}, "args": {"datatype": "mag"}}
], 
    "links": [
