...
const json_string_dicom = `{"nodes": [
        {"id": "4ce1b6d68a1211ec8516acde48001122", "props": {"type": "FILE" }, "inputs": [], "outputs": ["4ce1c07c8a1211ec8516acde48001122"], "styles": {"x": 50, "y": 50}, "args": {"filetype": "dicom", "filepath": "/Users/michael/projects/MRI/data/foot_data/"}}, 
        {"id": "4ce1c07c8a1211ec8516acde48001122", "props": {"type": "MASK" }, "inputs": ["4ce1b6d68a1211ec8516acde48001122"], "outputs": ["4ce1c7c08a1211ec8516acde48001122"],  "styles": {"x": 250, "y": 50}, "args": {"masktype": "circular"}}, 
        {"id": "4ce1c7c08a1211ec8516acde48001122", "props": {"type": "DISPLAY" }, "inputs": ["4ce1c07c8a1211ec8516acde48001122"], "outputs": [], "styles": {"x": 450, "y": 50}, "args": {}}
    ], 
    "links": [
...
export const load = async (json_string) => {
    const graph_json = await APIDataService.createGraph({json_string:json_string});
